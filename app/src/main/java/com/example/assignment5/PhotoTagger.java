...
public class PhotoTagger extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText)findViewById(R.id.createTags);
    ...
    public void filterImages(View view) {
        playAudio(R.raw.filter_sound);
        // get filter tags
        EditText filterTags = findViewById(R.id.filterTags);
        String tags = filterTags.getText().toString();
        itemList = new ArrayList<>();

        // constructing dynamic sql query
        String sqlQuery = "SELECT PICTURE, DATE, TAGS FROM IMAGES";
        if (!tags.equals("")) {
    ...
    protected void createImageList() {
        ...
        Cursor cursor = db.rawQuery("SELECT PICTURE, DATE, TAGS FROM IMAGES ORDER BY DATE DESC", null);
